...
class PublishFourRowResultsTest(unittest.TestCase):
    ...
    def test_live_evals_page_links_fourteen_row_table(self):
        ...
        self.assertIn("scores fourteen accepted sealed rows", readme)
        ...
        self.assertIn("method-divergent and quarantined with accepted score 0", readme)
        self.assertIn("QTIP3 uniform exact", readme)
        self.assertIn("QTIP2.5 deterministic mixed ring", readme)
