...
U69_SHA256 = "bf5b0166ad249814428f22aae6bd80ffc3325009b240aa694128e52aa4e505bf"
...
def test_authenticated_u69_broad_rot16_recovery_resume_is_admitted() -> None:
    config = _config()
    config["checkpoint_sha256"] = U69_SHA256
    meta = _meta()
    meta["sha256"] = U69_SHA256
    _validate_published_pre_resume_start(69, meta, config=config)
