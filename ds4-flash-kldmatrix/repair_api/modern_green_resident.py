...
TRAINER_SHA256 = "321aa817d469ea9eb7d6ad4886a255546b520388b2e6a6146261a5f1c0b0e06b"
...
def _published_pre_recipe_policy(
    ...
    if not 0 <= step <= max_step:
        raise ArtifactError(
            f"published PRE recipe cursor must be within U0..U{max_step}"
        )
    if step < 16:
