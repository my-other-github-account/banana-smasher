...
constexpr size_t MAX_GRAPH_CACHE_ENTRIES = 8;
...
GraphState* graph_state_for(
  ...
  TORCH_CHECK(
      ...
      "QTIP2 CUDA graph cache exhausted its bounded eight-stream capacity; "
      "reuse a resident solve stream instead of creating unbounded streams");
