...
| `sm121-deepgemm-dense-e8m0` | SM12x O-projection and dense preflight hooks | public DeepGEMM 2.5.0 `a6b593d2826719dcf4892609af7b84ee23aaf32a` source | stock SM100+ packed-scale O-projection with `VLLM_USE_DEEP_GEMM=1` and `VLLM_USE_DEEP_GEMM_E8M0=1` | SM121 dense/V4 tests |
