...
ROOT=Path('/dev/shm/t_1269dc5f');OUT=ROOT/'reference_ldl_run8545'; CONTROL=ROOT/'traceback_run8542r3';OLD=Path('/dev/shm/t_182fbc9d');CLAIM=Path('/home/dnola/HOST_CLAIM.json');BASE='2a118a825ef00ff67dd0cbc65d07cc67a2919089';CAND='2972151b8d2f64d6f0cb5730cd641fcb63ca8b1c'
...
if len(sys.argv)==1:
 ...
 with Path('/home/dnola/HOST_CLAIM.lock').open('a+') as lock:
  ...
  assert old['pid']==1821994 and old['start_ticks']==8200277
...
sys.path.insert(0,str((ROOT/'reference_ldl_code_run8545' if arm=='candidate' else ROOT/'traceback_base_run8542')/'banana-smasher/src'))
import torch
