...
ROOT=Path('/dev/shm/t_1269dc5f');OUT=ROOT/'licm_run8544r2'; CONTROL=ROOT/'traceback_run8542r3';OLD=Path('/dev/shm/t_182fbc9d');CLAIM=Path('/home/dnola/HOST_CLAIM.json');BASE='2a118a825ef00ff67dd0cbc65d07cc67a2919089';CAND='a295e9b2d795cced8d943d93ff6072a5c00879f2'
...
if len(sys.argv)==1:
 ...
 with Path('/home/dnola/HOST_CLAIM.lock').open('a+') as lock:
  ...
  assert old['pid']==1799664 and old['start_ticks']==8073959
