...
ROOT=Path('/dev/shm/t_6ac2b6f5');OUT=ROOT/'deployment_run8560';CONTROL=Path('/dev/shm/t_1269dc5f/traceback_run8542r3');CLAIM=Path('/home/dnola/HOST_CLAIM.json');CAND='c769d086701769b08fdc85d5191afc2aa321e3e7'
