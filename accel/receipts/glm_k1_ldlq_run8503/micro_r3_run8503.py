...
for batch in (256,1024):
 ...
 ref=None
 for name,dtype,warps,gather,unroll in [('main','int32',None,None,None),('int32_unroll','int32',16,None,True),('int32_w8_unroll','int32',8,None,True),('uint16_unroll','uint16',16,None,True)]:
