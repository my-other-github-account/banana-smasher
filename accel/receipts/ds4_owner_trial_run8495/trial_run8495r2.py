...
P=pathlib.Path
B=P('/home/dnola/missions/DS4_EMPTY_FIT_t_68e5892b'); R=B/'s8-K3-L011DOWN3-run8495r2'; CAN=B/'canonical-39da421e-run8495'; C=P('/home/dnola/HOST_CLAIM.json'); PLAN=B/'PLAN_TRIAL_run8495r2.json'
