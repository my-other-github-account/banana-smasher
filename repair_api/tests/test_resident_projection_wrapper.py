...
PROVIDER_SHA256 = "4ba1411601b186dd0d6a3a89c829320f1b50e3112a40db40034e9fbadfb5d552"
...
def test_public_projection_wrapper_binds_combined_gate_up_and_product_exactly() -> None:
    ...
    with pytest.raises(ArtifactError, match="requires provider 4ba14116"):
...
def test_sealed_w2_source_codes_reproduce_builder_mode_w2_bytes_and_linear() -> None:
    ...
    assert torch.equal(
        observed, torch.nn.functional.linear(hidden, expected_weight)
    )
